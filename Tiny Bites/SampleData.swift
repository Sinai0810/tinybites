...
let sampleRecipes: [Recipe] = [
    Recipe(
        ...
        type: "Breakfast",
        time: "15 minutes",
        description: "A smooth and nutritious carrot puree, perfect for babies starting solids.",
        ingredients: ["2 medium carrots", "Water"],
        steps: [
            "Wash and peel the carrots thoroughly.",
            "Cut carrots into small, uniform pieces.",
            "Boil for 10-15 minutes until very soft.",
            "Blend with a little water until smooth.",
            "Check temperature before serving."
        ],
        image: "pure_zanahoria",
        allergens: [],
        nutrition: ["calories": 45, "protein": 1, "fat": 0, "carbs": 11]
    ),
     Recipe(
            title: "Apple Compote",
            ageGroup: "6+ months",
    ...
    Recipe(
        ...
        Recipe(
            ...
            allergens: [],
            nutrition: ["Calories": 160 , "Protein": 14, "Carbs": 10, "Fat": 5]
        ),
    ...
    Recipe(
        ...
        allergens: ["Fish"],
        nutrition: ["Calories": 180, "Protein": 14, "Carbs": 6, "Fat": 10]
    ),
    ...
    Recipe(
        ...
        allergens: [],
        nutrition: ["Calories": 170, "Protein": 15, "Carbs": 8, "Fat": 5]
    ),
    ...
    Recipe(
        ...
        allergens: [],
        nutrition: ["Calories": 160, "Protein": 12, "Carbs": 12, "Fat": 4]
    )
